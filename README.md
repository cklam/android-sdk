...
The Android SDK provides you with programmatic access points to the relayr API, it allows you to use the relayr Cloud Platform in your application and in the future - handle Bluetooth LE connection to your sensor modules. 
