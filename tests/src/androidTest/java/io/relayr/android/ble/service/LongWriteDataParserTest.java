...
public class LongWriteDataParserTest {
    ...
    @Test public void writeEmptyPackageTest() {
        io.relayr.android.ble.service.LongWriteDataParser parser = new io.relayr.android.ble.service.LongWriteDataParser("".getBytes());
    ...
    @Test public void writeShortPackageTest() {
        io.relayr.android.ble.service.LongWriteDataParser parser = new io.relayr.android.ble.service.LongWriteDataParser("123".getBytes());
        byte[] first = parser.getData();
    ...
    @Test public void writeOneFullPackageTest() {
        io.relayr.android.ble.service.LongWriteDataParser parser = new io.relayr.android.ble.service.LongWriteDataParser("11111111111111".getBytes());
        byte[] first = parser.getData();
    ...
    @Test public void writeLongPackageTest() {
        io.relayr.android.ble.service.LongWriteDataParser parser = new io.relayr.android.ble.service.LongWriteDataParser("12345678911111abc".getBytes());
        byte[] first = parser.getData();
