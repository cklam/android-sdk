...
public class BaseServiceTest {
    ...
    private io.relayr.android.ble.service.BluetoothGattReceiver receiver = new BluetoothGattReceiver();
    private io.relayr.android.ble.service.BaseService baseService;
    ...
    @Before public void initialise() {
        ...
        baseService = new io.relayr.android.ble.service.BaseService(bleDevice, gatt, receiver);
    }

    @Test public void connectTest() {
        @SuppressWarnings("unchecked")
        Observer<io.relayr.android.ble.service.BaseService> observer = mock(Observer.class);

        io.relayr.android.ble.service.BaseService
                .doConnect(device, receiver, true)
                .map(new Func1<BluetoothGatt, io.relayr.android.ble.service.BaseService>() {
                    @Override
                    public io.relayr.android.ble.service.BaseService call(BluetoothGatt gatt) {
                        return new io.relayr.android.ble.service.BaseService(bleDevice, gatt, receiver);
                    }
                })
                .subscribe(observer);
        ...
        verify(observer, times(1)).onNext(any(io.relayr.android.ble.service.BaseService.class));
    }
    ...
    @Test public void disconnectTest() {
        ...
        io.relayr.android.ble.service.BaseService
                ...
                .map(new Func1<BluetoothGatt, io.relayr.android.ble.service.BaseService>() {
                    @Override
                    public io.relayr.android.ble.service.BaseService call(BluetoothGatt g) {
                        return new io.relayr.android.ble.service.BaseService(bleDevice, gatt, receiver);
                    }
                })
                .flatMap(new Func1<io.relayr.android.ble.service.BaseService, Observable<BleDevice>>() {
                    @Override
                    public Observable<BleDevice> call(io.relayr.android.ble.service.BaseService baseService) {
